...
export class Migrations1728513094591 implements MigrationInterface {
    name = 'Migrations1728513094591'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "user_model" (
                ...
                CONSTRAINT "PK_7d6bfa71f4d6a1fa0af1f688327" PRIMARY KEY ("id")
            )
        `);
        await queryRunner.query(`
